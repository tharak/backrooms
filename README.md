...
5. Explore with **WASD** and look with the mouse. Press **E** or click the marker to write. Face a wall, type up to 280 characters, and click **WRITE ON THE WALL**. Your chosen name is appended automatically.
6. In Level 0, find the ordinary-looking wall that does not stop you. Walk through it and choose **ENTER LEVEL 1**.
