...
document.querySelector('#send-message').addEventListener('click',async()=>{
  ...
  try{
    const level=LEVELS[currentLevelIndex],record={p:[Number(surface.x.toFixed(3)),Number(surface.z.toFixed(3))],n:Number(surface.normal.toFixed(4)),i:level.issueNumber,t:`${text} — ${name}`,c:color};
